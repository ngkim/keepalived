...
extern void alloc_bfd(char *, int);
extern bfd_data_t *alloc_bfd_data(void);
extern void dump_bfd_data(bfd_data_t *);
extern void free_bfd_data(bfd_data_t *);
extern int bfd_complete_init(void);
extern void alloc_bfd_buffer(void);
extern void free_bfd_buffer(void);
extern bfd_t *find_bfd_by_addr(struct sockaddr_storage *);
extern bfd_t *find_bfd_by_discr(u_int32_t);
extern bfd_t *find_bfd_by_name(char *);
extern u_int32_t rand_intv(u_int32_t, u_int32_t);
extern u_int32_t bfd_get_random_discr(bfd_data_t *);
